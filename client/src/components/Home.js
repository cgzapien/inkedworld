...
export default function Home(){
  ...
  return (
    <div style={{display: "relative", marginLeft: "10px", height: "100vh"}}>
      ...
      sx={{textAlign: "center"}} 
      variant="h5"
      >Welcome to Inked, a tattoo artist community. Where you can interact with other artist relating to the tattoo world. Here you can post threads about certain topics and other users are able to comment on them. Our goal is to provide a sense of community to tattoo artist across the world.</Typography>
